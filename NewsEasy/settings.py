"""
Django settings for NewsEasy project.
...
# logger settings
from NewsEasy.logger_settings import log_level, log_files_directory, logging_settings
...
WSGI_APPLICATION = 'NewsEasy.wsgi.application'
